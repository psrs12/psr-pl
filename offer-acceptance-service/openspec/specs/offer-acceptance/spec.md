...
Capability spec for `offer-acceptance-service`: declaration disclosure and e-signature capture. Consumed here from the platform-wide `rebuild-platform-go` change; this file is this service's own copy of record going forward.
